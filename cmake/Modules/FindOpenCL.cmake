...
ELSE (APPLE)
	IF (WIN32)
	    IF (DEFINED ENV{INTELOCLSDKROOT})
	      FIND_PATH(OPENCL_INCLUDE_DIRS CL/cl.h PATHS "$ENV{INTELOCLSDKROOT}/include" NO_DEFAULT_PATH NO_CMAKE_FIND_ROOT_PATH)
	      FIND_PATH(_OPENCL_CPP_INCLUDE_DIRS CL/cl.hpp PATHS "$ENV{INTELOCLSDKROOT}/include" NO_DEFAULT_PATH NO_CMAKE_FIND_ROOT_PATH)
	      SET(OPENCL_LIB_DIR "$ENV{INTELOCLSDKROOT}/lib/x64")
	    ELSE (ENV{INTELOCLSDKROOT})
